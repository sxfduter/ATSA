...
from depth_attention_module import DCA
...
class LadderNet(nn.Module):
    ...
    def __init__(self, cfg):
        ...
        # depth_stage2
        self.depth_attention_stage2 = DCA(
            inplanes=32,
            planes=32,
        )
        # depth_stage3
        self.depth_attention_stage3 = DCA(
            inplanes=32,
            planes=32,
        )
        # depth_stage4
        self.depth_attention_stage4 = DCA(
            inplanes=128,
            planes=128,
        )
